...
uint8_t LeftAdjust (uint8_t leftSet, uint8_t adjuster){
  if((ENC_vi32LeftEncoderARawTime > ENC_vi32RightEncoderARawTime)){
    return (leftSet + adjuster);
...
uint8_t RightAdjust (uint8_t rightSet, uint8_t adjuster){
  if((ENC_vi32LeftEncoderARawTime > ENC_vi32RightEncoderARawTime)){
    return (rightSet - adjuster);
  } else if ((ENC_vi32LeftEncoderARawTime < ENC_vi32RightEncoderARawTime)){
    return (rightSet + adjuster);
  } else {
    return rightSet;
